<template>
    <div class="container my-16 margin-x-24">
        <div class="d-flex flex-col relative">
            <form class="row max-w-container mx-auto form-bg-grey" id="form-searchbar-container" @submit.prevent="postSearch">
                ...
                <select class="form-control form-searchbar shadow-none" id="type" name="type" v-model="form.type">
                ...
                <select class="form-control form-searchbar shadow-none" id="operation" name="operation" v-model="form.operation">
                ...
                <input type="number" v-model="form.min" maxlength="100"
                       class="form-control form-searchbar smaller-input shadow-none"
                ...
                <button class="btn btn-danger w-150px">
                    buscar
                </button>
            </form>
