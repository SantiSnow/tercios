                            ...
                            <tr>
                                <td>
                                    <table cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <tr>
                                            <td class="table-cell">Dirección</td>
                                            <td class="table-cell" style="text-align: right;">{{ $address }}</td>
                                        </tr>
                                        <tr>
                                            <td class="table-cell">Localidad/Ciudad</td>
                                            <td class="table-cell" style="text-align: right;">{{ $city }}</td>
                                        </tr>
                                        <tr>
                                            <td class="table-cell">Provincia</td>
                                            <td class="table-cell" style="text-align: right;">{{ $estate }}</td>
                                        </tr>
